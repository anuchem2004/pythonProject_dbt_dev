from plugins.task.common import DummyTask, EntityTask, DiscoverFile, ParallelGroupEnd
from plugins.task.aws.emr.builder import DataExtractor, EMRJobStepSensor
from plugins.task.db.postgres.builder import PostgresSprocExecutionTask
from plugins.task.aws.athena.builder import AthenaTableCreateTask, AthenaTableDropTask, AthenaTableRepairTask, Bookmark
from plugins.task.aws.s3.builder import S3CopyFileTask, S3ChangeMetadataTask, S3DeleteFileTask
from plugins.db.oms_ods_admin import CdsDataProcessingStatusConfiguration, CdsDataProcessingTaskConfiguration
from airflow.utils.task_group import TaskGroup


class CdsDataProcessor(object):
    """docstring for CdsDataProcessor"""
...
class TaskFactory(object):
    ...
    TASK_LIST = {
        ...
        'postgres_sproc_execution': PostgresSprocExecutionTask,
        'emr_add_step': DataExtractor,
        'emr_step_sensor': EMRJobStepSensor,
        ...
        if sections:
            ...
            for section in sections:
                ...
                for t_obj in gt_list:
                    ...
                    g_s_key = t_obj['section_name'] if t_obj[
                                                           'sequence_no'] is None else f"{t_obj['section_name']}-{t_obj['sequence_no']}"
