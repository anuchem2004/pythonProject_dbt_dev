...
dag = DAG('random_row_generator', default_args=default_args, catchup=False)

generate_customers = PythonOperator(
    task_id='generate_customers_random',
